...
def parse_rooms(*_coconut_match_to_args, **_coconut_match_to_kwargs):  # line 5
    ...
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 1):  # line 5
        room = _coconut_match_to_args[0][0]  # line 5
        if (not _coconut_match_to_kwargs):  # line 5
            _coconut_match_check = True  # line 5
    if not _coconut_match_check:  # line 5
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def parse_rooms([room]) = -1'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))  # line 5
        _coconut_match_err.pattern = 'def parse_rooms([room]) = -1'  # line 5
        _coconut_match_err.value = _coconut_match_to_args  # line 5
        raise _coconut_match_err  # line 5

    return -1  # line 6

@addpattern(parse_rooms)  # line 7
@_coconut_tco  # line 7
def parse_rooms(*_coconut_match_to_args, **_coconut_match_to_kwargs):  # line 7
    _coconut_match_check = False  # line 7
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) >= 1):  # line 7
        rest = _coconut.list(_coconut_match_to_args[0][1:])  # line 7
        room = _coconut_match_to_args[0][0]  # line 7
        if (not _coconut_match_to_kwargs):  # line 7
            _coconut_match_check = True  # line 7
    if not _coconut_match_check:  # line 7
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def parse_rooms([room] + rest):'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))  # line 7
        _coconut_match_err.pattern = 'def parse_rooms([room] + rest):'  # line 7
        _coconut_match_err.value = _coconut_match_to_args  # line 7
        raise _coconut_match_err  # line 7

    index = room.find("[")  # line 10
    id_ = int(room[index - 3:index])  # line 11
    room_name = ((_coconut.functools.partial(map, lambda _=None: chr((ord(_) - 97 + id_) % 26 + 97)))(room[:index - 3].replace("-", "")))  # line 12
    if "north" in "".join(room_name):  # line 14
        return id_  # line 15
    else:  # line 16
        raise _coconut_tail_call(parse_rooms, rest)  # line 17

(print)(parse_rooms(rooms.splitlines()))  # line 19
