...
with open("slepice.txt", "r") as f :  # line 3
    message = f.read()  # line 4

common = (_coconut.functools.partial(map, Counter(_).most_common()[-1][0]))(zip(*message.splitlines()))  # line 6

print("".join(most_common))  # line 8
