...
def check_network_name(*_coconut_match_to_args, **_coconut_match_to_kwargs):  # line 2
    _coconut_match_check = False  # line 2
    if (_coconut.len(_coconut_match_to_args) == 4) and ("abas" not in _coconut_match_to_kwargs) and ("babs" not in _coconut_match_to_kwargs) and ("inside_brackets" not in _coconut_match_to_kwargs) and (_coconut.isinstance(_coconut_match_to_args[3], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[3]) == 0):  # line 2
        _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("abas")  # line 2
        _coconut_match_temp_1 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("babs")  # line 2
        _coconut_match_temp_2 = _coconut_match_to_args[2] if _coconut.len(_coconut_match_to_args) > 2 else _coconut_match_to_kwargs.pop("inside_brackets")  # line 2
        if (not _coconut_match_to_kwargs):  # line 2
            abas = _coconut_match_temp_0  # line 2
            babs = _coconut_match_temp_1  # line 2
            inside_brackets = _coconut_match_temp_2  # line 2
            _coconut_match_check = True  # line 2
    if not _coconut_match_check:  # line 2
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def check_network_name(abas, babs, inside_brackets, []) = len(abas.intersection(babs)) > 0'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))  # line 2
        _coconut_match_err.pattern = 'def check_network_name(abas, babs, inside_brackets, []) = len(abas.intersection(babs)) > 0'  # line 2
        _coconut_match_err.value = _coconut_match_to_args  # line 2
        raise _coconut_match_err  # line 2

    return len(abas.intersection(babs)) > 0  # line 2

@addpattern(check_network_name)  # line 3
@_coconut_tco  # line 3
def check_network_name(*_coconut_match_to_args, **_coconut_match_to_kwargs):  # line 3
    _coconut_match_check = False  # line 3
    if (_coconut.len(_coconut_match_to_args) == 4) and ("abas" not in _coconut_match_to_kwargs) and ("babs" not in _coconut_match_to_kwargs) and ("inside_brackets" not in _coconut_match_to_kwargs) and (_coconut.isinstance(_coconut_match_to_args[3], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[3]) >= 1):  # line 3
        _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("abas")  # line 3
        _coconut_match_temp_1 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("babs")  # line 3
        _coconut_match_temp_2 = _coconut_match_to_args[2] if _coconut.len(_coconut_match_to_args) > 2 else _coconut_match_to_kwargs.pop("inside_brackets")  # line 3
        rest = _coconut.list(_coconut_match_to_args[3][1:])  # line 3
        triplet = _coconut_match_to_args[3][0]  # line 3
        if (not _coconut_match_to_kwargs):  # line 3
            abas = _coconut_match_temp_0  # line 3
            babs = _coconut_match_temp_1  # line 3
            inside_brackets = _coconut_match_temp_2  # line 3
            _coconut_match_check = True  # line 3
    if not _coconut_match_check:  # line 3
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def check_network_name(abas, babs, inside_brackets, [triplet] + rest):'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))  # line 3
        _coconut_match_err.pattern = 'def check_network_name(abas, babs, inside_brackets, [triplet] + rest):'  # line 3
        _coconut_match_err.value = _coconut_match_to_args  # line 3
        raise _coconut_match_err  # line 3

    if triplet[0] in "[]":  # line 6
        raise _coconut_tail_call(check_network_name, abas, babs, not inside_brackets, rest)  # line 7

    if (triplet[0] == triplet[2] and triplet[0] != triplet[1] and triplet[1] not in "[]"):  # line 9
        if inside_brackets:  # line 11
            raise _coconut_tail_call(check_network_name, abas, babs | set(("{1}{0}{1}".format(triplet[0], triplet[1]),)), inside_brackets, rest)  # line 12
        else:  # line 15
            raise _coconut_tail_call(check_network_name, abas | set((triplet,)), babs, inside_brackets, rest)  # line 16

    raise _coconut_tail_call(check_network_name, abas, babs, inside_brackets, rest)  # line 19


def check_networks(*_coconut_match_to_args, **_coconut_match_to_kwargs):  # line 20
    _coconut_match_check = False  # line 20
    if (1 <= _coconut.len(_coconut_match_to_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 1, "count" in _coconut_match_to_kwargs)) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 0):  # line 20
        _coconut_match_temp_0 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("count")  # line 20
        if (not _coconut_match_to_kwargs):  # line 20
            count = _coconut_match_temp_0  # line 20
            _coconut_match_check = True  # line 20
    if not _coconut_match_check:  # line 20
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def check_networks([], count) = count'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))  # line 20
        _coconut_match_err.pattern = 'def check_networks([], count) = count'  # line 20
        _coconut_match_err.value = _coconut_match_to_args  # line 20
        raise _coconut_match_err  # line 20

    return count  # line 22

@addpattern(check_networks)  # line 23
@_coconut_tco  # line 23
def check_networks(*_coconut_match_to_args, **_coconut_match_to_kwargs):  # line 23
    _coconut_match_check = False  # line 23
    if (1 <= _coconut.len(_coconut_match_to_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 1, "count" in _coconut_match_to_kwargs)) <= 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) >= 1):  # line 23
        _coconut_match_temp_0 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("count") if "count" in _coconut_match_to_kwargs else 0  # line 23
        rest = _coconut.list(_coconut_match_to_args[0][1:])  # line 23
        network = _coconut_match_to_args[0][0]  # line 23
        if (not _coconut_match_to_kwargs):  # line 23
            count = _coconut_match_temp_0  # line 23
            _coconut_match_check = True  # line 23
    if not _coconut_match_check:  # line 23
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def check_networks([network] + rest, count=0):'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))  # line 23
        _coconut_match_err.pattern = 'def check_networks([network] + rest, count=0):'  # line 23
        _coconut_match_err.value = _coconut_match_to_args  # line 23
        raise _coconut_match_err  # line 23

    valid = ((_coconut.functools.partial(check_network_name, set(), set(), False))((list)((_coconut.functools.partial(map, lambda _=None: network[_:_ + 3]))(range(len(network[:-2]))))))  # line 26

    raise _coconut_tail_call(check_networks, rest, count + int(valid))  # line 31

with open("slepice.txt", "r") as f :  # line 33
    networks = f.read()  # line 34
(print)(check_networks(networks.splitlines()))  # line 35
