...
def check_network_name(*_coconut_match_to_args, **_coconut_match_to_kwargs):  # line 2
    ...
    if (_coconut.len(_coconut_match_to_args) == 3) and ("abba_outside" not in _coconut_match_to_kwargs) and ("inside_brackets" not in _coconut_match_to_kwargs) and (_coconut.isinstance(_coconut_match_to_args[2], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[2]) == 0):  # line 2
        _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("abba_outside")  # line 2
        _coconut_match_temp_1 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("inside_brackets")  # line 2
        if (not _coconut_match_to_kwargs):  # line 2
            abba_outside = _coconut_match_temp_0  # line 2
            inside_brackets = _coconut_match_temp_1  # line 2
            _coconut_match_check = True  # line 2
    if not _coconut_match_check:  # line 2
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def check_network_name(abba_outside, inside_brackets, []) = abba_outside'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))  # line 2
        _coconut_match_err.pattern = 'def check_network_name(abba_outside, inside_brackets, []) = abba_outside'  # line 2
        _coconut_match_err.value = _coconut_match_to_args  # line 2
        raise _coconut_match_err  # line 2

    return abba_outside  # line 2
...
def check_network_name(*_coconut_match_to_args, **_coconut_match_to_kwargs):  # line 3
    ...
    if (_coconut.len(_coconut_match_to_args) == 3) and ("abba_outside" not in _coconut_match_to_kwargs) and ("inside_brackets" not in _coconut_match_to_kwargs) and (_coconut.isinstance(_coconut_match_to_args[2], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[2]) >= 1):  # line 3
        _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("abba_outside")  # line 3
        _coconut_match_temp_1 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("inside_brackets")  # line 3
        rest = _coconut.list(_coconut_match_to_args[2][1:])  # line 3
        quartet = _coconut_match_to_args[2][0]  # line 3
        if (not _coconut_match_to_kwargs):  # line 3
            abba_outside = _coconut_match_temp_0  # line 3
            inside_brackets = _coconut_match_temp_1  # line 3
            _coconut_match_check = True  # line 3
    if not _coconut_match_check:  # line 3
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def check_network_name(abba_outside, inside_brackets, [quartet] + rest):'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))  # line 3
        _coconut_match_err.pattern = 'def check_network_name(abba_outside, inside_brackets, [quartet] + rest):'  # line 3
        _coconut_match_err.value = _coconut_match_to_args  # line 3
        raise _coconut_match_err  # line 3

    if quartet[0] in "[]":  # line 6
        raise _coconut_tail_call(check_network_name, abba_outside, not inside_brackets, rest)  # line 7
    if quartet == "".join(reversed(quartet)) and quartet[0] != quartet[1]:  # line 8
        if inside_brackets:  # line 9
            return False  # line 10
        else:  # line 11
            abba_outside = True  # line 12

    raise _coconut_tail_call(check_network_name, abba_outside, inside_brackets, rest)  # line 14

def check_networks(*_coconut_match_to_args, **_coconut_match_to_kwargs):  # line 15
    _coconut_match_check = False  # line 15
    if (1 <= _coconut.len(_coconut_match_to_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 1, "count" in _coconut_match_to_kwargs)) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 0):  # line 15
        _coconut_match_temp_0 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("count")  # line 15
        if (not _coconut_match_to_kwargs):  # line 15
            count = _coconut_match_temp_0  # line 15
            _coconut_match_check = True  # line 15
    if not _coconut_match_check:  # line 15
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def check_networks([], count) = count'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))  # line 15
        _coconut_match_err.pattern = 'def check_networks([], count) = count'  # line 15
        _coconut_match_err.value = _coconut_match_to_args  # line 15
        raise _coconut_match_err  # line 15

    return count  # line 16

@addpattern(check_networks)  # line 17
@_coconut_tco  # line 17
def check_networks(*_coconut_match_to_args, **_coconut_match_to_kwargs):  # line 17
    _coconut_match_check = False  # line 17
    if (1 <= _coconut.len(_coconut_match_to_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 1, "count" in _coconut_match_to_kwargs)) <= 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) >= 1):  # line 17
        _coconut_match_temp_0 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("count") if "count" in _coconut_match_to_kwargs else 0  # line 17
        rest = _coconut.list(_coconut_match_to_args[0][1:])  # line 17
        network = _coconut_match_to_args[0][0]  # line 17
        if (not _coconut_match_to_kwargs):  # line 17
            count = _coconut_match_temp_0  # line 17
            _coconut_match_check = True  # line 17
    if not _coconut_match_check:  # line 17
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def check_networks([network] + rest, count=0):'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))  # line 17
        _coconut_match_err.pattern = 'def check_networks([network] + rest, count=0):'  # line 17
        _coconut_match_err.value = _coconut_match_to_args  # line 17
        raise _coconut_match_err  # line 17

    valid = ((_coconut.functools.partial(check_network_name, False, False))((list)((_coconut.functools.partial(map, lambda _=None: network[_:_ + 4]))(range(len(network[:-3]))))))  # line 20

    raise _coconut_tail_call(check_networks, rest, count + int(valid))  # line 25

with open("slepice.txt", "r") as f :  # line 27
    networks = f.read()  # line 28
(print)(check_networks(networks.splitlines()))  # line 29
