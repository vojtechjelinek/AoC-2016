...
with open("slepice.txt", "r") as f :  # line 1
    instructs = f.read()  # line 2

pinstr = ((_coconut.functools.partial(map, lambda x: [int(x[i:i + 5]) for i in range(0, 11, 5)]))(instructs.splitlines()))  # line 4

#can_be_constructed = ([x, y, z]) -> x + y > z
def _coconut_lambda_0(*_coconut_match_to_args, **_coconut_match_to_kwargs):  # line 8
    _coconut_match_check = False  # line 8
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 3):  # line 8
        x = _coconut_match_to_args[0][0]  # line 8
        y = _coconut_match_to_args[0][1]  # line 8
        z = _coconut_match_to_args[0][2]  # line 8
        if (not _coconut_match_to_kwargs):  # line 8
            _coconut_match_check = True  # line 8
    if not _coconut_match_check:  # line 8
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'can_be_constructed2 = def ([x, y, z]) -> x + y > z'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))  # line 8
        _coconut_match_err.pattern = 'can_be_constructed2 = def ([x, y, z]) -> x + y > z'  # line 8
        _coconut_match_err.value = _coconut_match_to_args  # line 8
        raise _coconut_match_err  # line 8
    return x + y > z  # line 8
can_be_constructed2 = _coconut_lambda_0  # line 8

transformed_instructs = ((_coconut.functools.partial(map, sorted))(reduce(_coconut.operator.add, (_coconut.functools.partial(map, lambda i: (list)(zip(*pinstr[i:i + 3]))))(range(0, len(pinstr), 3)))))  # line 10

def _coconut_lambda_1(*_coconut_match_to_args, **_coconut_match_to_kwargs):  # line 11
    _coconut_match_check = False  # line 11
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 3):  # line 11
        x = _coconut_match_to_args[0][0]  # line 11
        y = _coconut_match_to_args[0][1]  # line 11
        z = _coconut_match_to_args[0][2]  # line 11
        if (not _coconut_match_to_kwargs):  # line 11
            _coconut_match_check = True  # line 11
    if not _coconut_match_check:  # line 11
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'transformed_instructs |> map$(def ([x, y, z]) -> x + y > z) |> sum |> print'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))  # line 11
        _coconut_match_err.pattern = 'transformed_instructs |> map$(def ([x, y, z]) -> x + y > z) |> sum |> print'  # line 11
        _coconut_match_err.value = _coconut_match_to_args  # line 11
        raise _coconut_match_err  # line 11
    return x + y > z  # line 11
(print)((sum)((_coconut.functools.partial(map, _coconut_lambda_1))(transformed_instructs)))  # line 15
