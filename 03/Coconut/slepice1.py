...
parsed_instructs = ((_coconut.functools.partial(map, sorted))((_coconut.functools.partial(map, lambda x: [int(x[i:i + 5]) for i in range(0, 11, 5)]))(instructs.splitlines()))) # line 6
(print)((sum)((_coconut.functools.partial(map, can_be_constructed))(parsed_instructs))) # line 9
