...
@_coconut_tco # line 1
def factorial(n, acc=1): # line 1
    _coconut_match_check = False # line 2
    _coconut_match_to = n # line 2
    if (_coconut_match_to == 0): # line 2
        _coconut_match_check = True # line 2
    if _coconut_match_check: # line 2
        return acc # line 4
    if not _coconut_match_check: # line 5
        _coconut_match_to = n # line 5
        if (_coconut.isinstance(_coconut_match_to, int)): # line 5
            if (n > 0): # line 5
                _coconut_match_check = True # line 5
        if _coconut_match_check: # line 5
            raise _coconut_tail_call(factorial, n - 1, acc * n) # line 6
    if not _coconut_match_check: # line 7
        raise TypeError("the argument to factorial must be an integer >= 0") # line 8
