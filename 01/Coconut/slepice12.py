...
class point(_coconut.collections.namedtuple("point", "x, y, orientation, visited_poses")): # line 1
    __slots__ = () # line 1
    def move(*_coconut_match_to): # line 1
        _coconut_match_check = False # line 1
        if (_coconut.len(_coconut_match_to) == 2) and (_coconut_match_to[1] == 0): # line 1
            self = _coconut_match_to[0] # line 1
            _coconut_match_check = True # line 1
        if not _coconut_match_check: # line 1
            _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def move(self, 0) = self'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to))) # line 1
            _coconut_match_err.pattern = 'def move(self, 0) = self' # line 1
            _coconut_match_err.value = _coconut_match_to # line 1
            raise _coconut_match_err # line 1

        return self # line 2
    @addpattern(move) # line 3
    def move(self, steps): # line 4
        _coconut_match_check = False # line 5
        _coconut_match_to = self.orientation # line 5
        if (_coconut_match_to == 0): # line 5
            _coconut_match_check = True # line 5
        if _coconut_match_check: # line 5
            return self.visit()._replace(y=self.y + 1).move(steps - 1) # line 7
        if not _coconut_match_check: # line 8
            _coconut_match_to = self.orientation # line 8
            if (_coconut_match_to == 1): # line 8
                _coconut_match_check = True # line 8
            if _coconut_match_check: # line 8
                return self.visit()._replace(x=self.x + 1).move(steps - 1) # line 9
        if not _coconut_match_check: # line 10
            _coconut_match_to = self.orientation # line 10
            if (_coconut_match_to == 2): # line 10
                _coconut_match_check = True # line 10
            if _coconut_match_check: # line 10
                return self.visit()._replace(y=self.y - 1).move(steps - 1) # line 11
        if not _coconut_match_check: # line 12
            _coconut_match_to = self.orientation # line 12
            if (_coconut_match_to == 3): # line 12
                _coconut_match_check = True # line 12
            if _coconut_match_check: # line 12
                return self.visit()._replace(x=self.x - 1).move(steps - 1) # line 13

    @_coconut_tco # line 14
    def visit(self): # line 14
        raise _coconut_tail_call(self._replace, visited_poses=self.visited_poses + [(self.x, self.y)]) # line 16

    def perform_instruction(self, inst): # line 17
        return self.turn(inst[0]).move(int(inst[1:])) # line 18

    @_coconut_tco # line 19
    def turn(*_coconut_match_to): # line 19
        _coconut_match_check = False # line 19
        if (_coconut.len(_coconut_match_to) == 2) and (_coconut_match_to[1] == "R"): # line 19
            self = _coconut_match_to[0] # line 19
            _coconut_match_check = True # line 19
        if not _coconut_match_check: # line 19
            _coconut_match_err = _coconut_MatchError("pattern-matching failed for " '\'def turn(self, "R") =\'' " in " + _coconut.repr(_coconut.repr(_coconut_match_to))) # line 19
            _coconut_match_err.pattern = 'def turn(self, "R") =' # line 19
            _coconut_match_err.value = _coconut_match_to # line 19
            raise _coconut_match_err # line 19

        raise _coconut_tail_call(self._replace, orientation=(self.orientation + 1) % 4) # line 21
    @addpattern(turn) # line 22
    @_coconut_tco # line 22
    def turn(*_coconut_match_to): # line 22
        _coconut_match_check = False # line 22
        if (_coconut.len(_coconut_match_to) == 2) and (_coconut_match_to[1] == "L"): # line 22
            self = _coconut_match_to[0] # line 22
            _coconut_match_check = True # line 22
        if not _coconut_match_check: # line 22
            _coconut_match_err = _coconut_MatchError("pattern-matching failed for " '\'def turn(self, "L") =\'' " in " + _coconut.repr(_coconut.repr(_coconut_match_to))) # line 22
            _coconut_match_err.pattern = 'def turn(self, "L") =' # line 22
            _coconut_match_err.value = _coconut_match_to # line 22
            raise _coconut_match_err # line 22

        raise _coconut_tail_call(self._replace, orientation=(self.orientation - 1) % 4) # line 24

    @_coconut_tco # line 25
    def first_intersection(self): # line 26
        visited_before = lambda i: self.visited_poses[i] in self.visited_poses[:i] # line 27
        j = _coconut_igetitem(((_coconut.functools.partial(filter, visited_before))((range)((len)(self.visited_poses)))), 0) # line 28
        x, y = self.visited_poses[j] # line 29
        raise _coconut_tail_call(point, x, y, 0, 0) # line 30

    @_coconut_tco # line 31
    def __abs__(self): # line 31
        raise _coconut_tail_call(abs, self.x - self.y) # line 32

@_coconut_tco # line 33
def perform_instructions(*_coconut_match_to): # line 33
    _coconut_match_check = False # line 33
    if (_coconut.len(_coconut_match_to) == 2) and (_coconut.isinstance(_coconut_match_to[1], _coconut.abc.Iterable)): # line 33
        pos = _coconut_match_to[0] # line 33
        rest = _coconut.iter(_coconut_match_to[1]) # line 33
        _coconut_match_iter_0 = _coconut.tuple(_coconut_igetitem(rest, _coconut.slice(None, 1))) # line 33
        if (_coconut.len(_coconut_match_iter_0) == 1): # line 33
            instruct = _coconut_match_iter_0[0] # line 33
            _coconut_match_check = True # line 33
    if not _coconut_match_check: # line 33
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def perform_instructions(pos, [instruct] :: rest) ='" " in " + _coconut.repr(_coconut.repr(_coconut_match_to))) # line 33
        _coconut_match_err.pattern = 'def perform_instructions(pos, [instruct] :: rest) =' # line 33
        _coconut_match_err.value = _coconut_match_to # line 33
        raise _coconut_match_err # line 33

    raise _coconut_tail_call(perform_instructions, pos.perform_instruction(instruct), rest) # line 35

@addpattern(perform_instructions) # line 36
def perform_instructions(*_coconut_match_to): # line 36
    _coconut_match_check = False # line 36
    if (_coconut.len(_coconut_match_to) == 2) and (_coconut.isinstance(_coconut_match_to[1], _coconut.abc.Iterable)): # line 36
        pos = _coconut_match_to[0] # line 36
        _coconut_match_iter_0 = _coconut.tuple(_coconut_match_to[1]) # line 36
        if (_coconut.len(_coconut_match_iter_0) == 0): # line 36
            _coconut_match_check = True # line 36
    if not _coconut_match_check: # line 36
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def perform_instructions(pos, (||)) = (abs(pos), abs(pos.first_intersection()))'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to))) # line 36
        _coconut_match_err.pattern = 'def perform_instructions(pos, (||)) = (abs(pos), abs(pos.first_intersection()))' # line 36
        _coconut_match_err.value = _coconut_match_to # line 36
        raise _coconut_match_err # line 36

    return (abs(pos), abs(pos.first_intersection())) # line 38
with open("slepice.txt", "r") as f : # line 39
    instructions = f.read() # line 40

(print)((_coconut.functools.partial(perform_instructions, point(0, 0, 0, [])))(instructions.split(", "))) # line 42
